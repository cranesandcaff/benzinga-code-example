 ...
 */
angular.module('benzingaStockExchangeApp')
  .factory('Portfolio', ["$http", "$sessionStorage", "FlashService", function ($http, $sessionStorage, FlashService) {
    return {
      /**
 ...
 */
angular.module('benzingaStockExchangeApp')
  .controller('portfolioCtrl', ["$scope", "$filter", "Portfolio", function ($scope, $filter, Portfolio) {
    /**
 ...
 */
angular.module('benzingaStockExchangeApp').factory('FlashService', ["$rootScope", function($rootScope){
    return {
      /**
